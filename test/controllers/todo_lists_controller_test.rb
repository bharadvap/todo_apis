...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { completed: @todo_list.completed, description: @todo_list.description, title: @todo_list.title } }, as: :json
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { completed: @todo_list.completed, description: @todo_list.description, title: @todo_list.title } }, as: :json
    assert_response 200
  end
